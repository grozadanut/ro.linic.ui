...
public class OpenManagerPartHandler
{
	...
	{
		toolItem = (HandledToolItemImpl) modelService.find("linic_gest_client.handledtoolitem.trimbar.manager", 
	...
	{
		partService.showPart(ManagerPart.PART_ID, PartState.ACTIVATE);
	}
