...
import ro.linic.ui.legacy.parts.SettingsPart;
...
public class SettingsHandler
{
	...
	{
		toolItem = (HandledToolItemImpl) modelService.find("linic_gest_client.handledtoolitem.trimbar.settings", 
	...
	{
		partService.showPart(SettingsPart.PART_ID, PartState.ACTIVATE);
	}
	
	@CanExecute
	boolean canExecute(final EPartService partService)
	{
		final boolean canExecute = ClientSession.instance().hasStrictPermission(Permissions.SETTINGS);
