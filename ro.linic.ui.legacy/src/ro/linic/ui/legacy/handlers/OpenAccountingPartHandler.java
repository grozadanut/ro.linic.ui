...
import ro.linic.ui.legacy.parts.AccountingPart;
import ro.linic.ui.legacy.session.ClientSession;

public class OpenAccountingPartHandler
{
	...
	{
		toolItem = (HandledToolItemImpl) modelService.find("linic_gest_client.handledtoolitem.trimbar.accounting", 
	...
	{
		partService.showPart(AccountingPart.PART_ID, PartState.ACTIVATE);
	}
