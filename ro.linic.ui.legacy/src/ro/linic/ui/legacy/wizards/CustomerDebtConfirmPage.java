...
public class CustomerDebtConfirmPage extends WizardPage
{
	private Text resultDescription;
	
	public CustomerDebtConfirmPage()
	{
        super("Confirma");
        setTitle("Confirmati");
	...
	public CustomerDebtConfirmPage resultDescription(final String description)
	{
