...
public class SumQuantitiesSummary implements ISummaryProvider
{
	final private IDataProvider dataProvider;
	final private int uomColIndex;
	final private int quantityColIndex;
	
	public SumQuantitiesSummary(final IDataProvider dataProvider, final int uomColIndex, final int quantityColIndex)
	{
