...
{
	public static final String PART_ID = "linic_gest_client.part.vanzari"; //$NON-NLS-1$
	public static final String PART_DESCRIPTOR_ID = "linic_gest_client.partdescriptor.vanzari"; //$NON-NLS-1$
	
	public static final String VANZARE_PART_TYPE_KEY = "vanzare_part_type_key"; //$NON-NLS-1$
	public static final String VANZARE_PART_TYPE_DEFAULT = "1"; //$NON-NLS-1$
	...
	private void addListeners()
	{
		...
		incarcaBonuriButton.addSelectionListener(new SelectionAdapter()
		{
			@Override public void widgetSelected(final SelectionEvent e)
			{
				...
				new VanzariIncarcaDocDialog(Display.getCurrent().getActiveShell(), VanzarePart.this, ctx).open();
	...
	public void closeBon(final TipInchidere tipInchidere)
	{
		if (bonCasa != null)
		{
			final InchideBonWizardDialog wizardDialog = new InchideBonWizardDialog(
					...
					new InchideBonWizard(bonCasa, casaActivaButton.getSelection(), null, ctx, bundle, log, tipInchidere));
