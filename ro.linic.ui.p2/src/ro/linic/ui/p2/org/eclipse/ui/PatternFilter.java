...
public class PatternFilter extends ViewerFilter {
	...
	public Object[] filter(final Viewer viewer, final Object parent, final Object[] elements) {
		...
		if (filtered == null) {
			final Boolean foundAny = (Boolean) foundAnyCache.get(parent);
	 ...
	 */
	private boolean isAnyVisible(final Viewer viewer, final Object parent, final Object[] elements) {
		if (matcher == null) {
			return true;
		}
		...
		final Object[] filtered = (Object[]) cache.get(parent);
		if (filtered != null) {
	 ...
	 */
	private boolean computeAnyVisible(final Viewer viewer, final Object[] elements) {
	...
	protected boolean isParentMatch(final Viewer viewer, final Object element) {
		if (viewer instanceof AbstractTreeViewer
			...
			final Object[] children = ((ITreeContentProvider) ((AbstractTreeViewer) viewer).getContentProvider())
					.getChildren(element);
	...
	protected boolean isLeafMatch(final Viewer viewer, final Object element) {
		final String labelText = ((ILabelProvider) ((ContentViewer) viewer).getLabelProvider()).getText(element);
	...
	protected boolean wordMatches(final String text) {
		...
		final String[] words = TextMatcher.getWords(text);
