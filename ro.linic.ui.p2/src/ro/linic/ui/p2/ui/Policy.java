...
public class Policy {
	...
	public Policy(final IEclipseContext ctx) {
		this.ctx = ctx;
	}
	 ...
	 */
	public boolean continueWorkingWithOperation(final ProfileChangeOperation operation, final Shell shell) {
		...
		if (status.getCode() == UpdateOperation.STATUS_NOTHING_TO_UPDATE) {
			ProvUI.reportStatus(ctx, status, StatusManager.BLOCK);
			return false;
		}

		// there is no plan, so we can't continue. Report any reason found
		if (operation.getProvisioningPlan() == null && !status.isOK()) {
			ProvUI.reportStatus(ctx, status, StatusManager.LOG | StatusManager.SHOW);
			return false;
		}
	 ...
	 */
	public void setVisibleAvailableIUQuery(final IQuery<IInstallableUnit> query) {
	 ...
	 */
	public void setVisibleInstalledIUQuery(final IQuery<IInstallableUnit> query) {
	 ...
	 * @see #RESTART_POLICY_PROMPT_RESTART_OR_APPLY
	 */
	public void setRestartPolicy(final int restartPolicy) {
	 ...
	 *                <code>false</code> if they are not.
	 */
	public void setRepositoriesVisible(final boolean visible) {
	 ...
	 */
	public void setShowDrilldownRequirements(final boolean drilldown) {
	 ...
	 *              <code>false</code> if categories should not be shown.
	 */
	public void setGroupByCategory(final boolean group) {
	...
	public void setRepositoryPreferencePageId(final String id) {
	...
	public void setRepositoryPreferencePageName(final String name) {
	...
	public void setUpdateWizardStyle(final int updateWizardStyle) {
	...
	public void setUpdateDetailsPreferredSize(final Point preferredSize) {
	 ...
	 * @since 2.3
	 */
	public void setContactAllSites(final boolean contactAll) {
	 ...
	 * @since 2.6
	 */
	public void setCheckAgainstCurrentExecutionEnvironment(final boolean check) {
