...
import ro.linic.ui.p2.internal.ui.ElementQueryDescriptor;
...
public abstract class QueriedElement extends ProvElement {
	...
	protected QueriedElement(final IEclipseContext ctx, final Object parent) {
		super(ctx, parent);
	}
	...
	protected Object[] fetchChildren(final Object o, final IProgressMonitor monitor) {
		...
		final QueryProvider provider = new QueryProvider(ctx, getProvisioningUI());
		final ElementQueryDescriptor queryDescriptor = provider.getQueryDescriptor(this);
		if (queryDescriptor == null)
			return new Object[0];
		final Collection<?> results = queryDescriptor.performQuery(monitor);
	...
	protected Object[] getFilteredChildren(final Collection<?> results) {
		final Collection<Object> returnedChildren = new HashSet<>();
		returnedChildren.addAll(results);
		final Object[] siblings = getSiblings();
	...
	public void setQueryable(final IQueryable<?> queryable) {
