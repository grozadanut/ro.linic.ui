...
public class IUColumnConfig {
	...
	public IUColumnConfig(final String title, final int columnType, final int columnWidthInChars) {
	 ...
	 * @since 3.6
	 */
	public void setColumnTitle(final String title) {
		this.columnTitle = title;
	}
	 ...
	 * @since 3.6
	 */
	public void setWidthInChars(final int columnWidth) {
	 ...
	 */
	public int getWidthInPixels(final Control control) {
	 ...
	 * @since 3.6
	 */
	public void setWidthInPixels(final int width) {
	 ...
	 * @see #COLUMN_VERSION
	 */
	public void setColumnType(final int type) {
