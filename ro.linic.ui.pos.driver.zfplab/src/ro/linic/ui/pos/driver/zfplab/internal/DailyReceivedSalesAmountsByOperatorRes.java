...
public class DailyReceivedSalesAmountsByOperatorRes {
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 0
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 1
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 2
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 3
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 4
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 5
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 6
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 7
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 8
    */
   ...
   /**
    *Up to 11 symbols for amounts received by sales for payment 9
    */
