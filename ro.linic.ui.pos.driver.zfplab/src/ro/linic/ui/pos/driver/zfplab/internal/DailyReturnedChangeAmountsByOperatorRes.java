...
public class DailyReturnedChangeAmountsByOperatorRes {
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 0
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 1
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 2
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 3
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 4
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 5
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 6
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 7
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 8
    */
   ...
   /**
    *Up to 11 symbols for amounts received by type of payment 9
    */
