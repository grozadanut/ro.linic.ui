...
public class ClientDataRes {
    ...
    */
    public String CustomerVatN;
    public String getCustomerVatN() {
       return CustomerVatN;
    }
    protected void setCustomerVatN(final String value) {
       CustomerVatN = value;
    }
    ...
    */
    ...
    protected void setCustomerAddr(final String value) {
       CustomerAddr = value;
    }
    ...
    */
    public Double CustTurn;
    public Double getCustTurn() {
       return CustTurn;
    }
    protected void setCustTurn(final Double value) {
       CustTurn = value;
    }
}
